...
from page import Page, parse_html, redirect, insert_image_form_data, check_image_exists, check_error_msg, validate_date, put_entity_into_db


class LostFormEdit(Page):
    def __init__(self):
        Page.__init__(self, "lost_form_edit", html_file="lost_form_edit/index", bypass=False, public=False)
    ...
    def post(self, event=None, path=None, post={}, error_msg=None, user=None):
        ...
        path["case"]["case_name"] = post.get("case_name").lower().strip()
